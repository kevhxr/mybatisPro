...
public class DBConfig extends AbstractDBConfig {
    ...
    public static final String PTM_BEAN_NAME = "transactionManager";
    public static final String SST_BEAN_NAME = "mySqlSessionTemplate";
    public static final String SSF_BEAN_NAME = "mySqlSessionFactory";
    public static final String BASE_PACKAGE = "com.xr.mapper.UserMapper";
...
*/
    ...
    public SqlSessionTemplate getSqlSessionTemplate(@Qualifier(SSF_BEAN_NAME) SqlSessionFactory sqlSessionFactory) {
        System.out.println("-----getSqlSessionTemplate----");
